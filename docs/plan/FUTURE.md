...
**Personal Memory Phase 0 / 1A / 1B 与 Importer v2A / v2B 已于 2026-07-22 经 owner 接受。最终合同见 `docs/plan/SPRINT.md`，acceptance 记录见 `docs/plan/HISTORY.md`。下一优先项为 MCP / toolkit 对齐。**
